 ...
 * @author BIT-USER
 */
public class CatchMind extends javax.swing.JFrame {

    /**
     * Creates new form CatchMind
     */
    public CatchMind() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatchMind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
